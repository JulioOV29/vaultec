...
import { LayoutDashboard, Monitor, Users, LogOut, X, Save, UserPlus, Menu } from 'lucide-react'
                ...
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-xs sm:text-sm mt-0.5">Administra los accesos al sistema</p>
                        </div>
                    </div>
                    <button
                                ...
                                {usuarios.map((u, i) => (
                                    <tr key={u.id} className="hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${u.rol === 'ADMIN' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'
                                                }`}>
                                                {u.rol}
                                            </span>
                                        </td>
